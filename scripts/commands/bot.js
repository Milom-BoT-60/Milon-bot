...
const cuteReplies = [
  ...
  "bye", "naw message daw Message MILON HASAN: https://m.me/MILON.HASAN", "mb ney bye", "meww", "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏",
  "𝗜 𝗹𝗼𝘃𝗲 𝘆𝗼𝘂__😘😘", "𝗜 𝗵𝗮𝘁𝗲 𝘆𝗼𝘂__😏😏", "গোসল করে আসো যাও😑😩", "⎯͢⎯⃝🌺⋆⃝আ্ঁস্ঁসা্ঁলা্ঁমু্ঁ ও্ঁয়া্ঁলা্ঁই্ঁকু্ঁম্ঁ⋆⃝༎⎯⃝__✨", "কেমন আসো",
  ...
  "𝗕𝗼𝘁 𝗕𝗼𝘁 না করে আমার বস মিলন এর লগে প্রেম করতে পারো😑?", "আমার সোনার বাংলা, তারপরে লাইন কি? 🙈", "🍺 এই নাও জুস খাও..!𝗕𝗼𝘁 বলতে বলতে হাপায় গেছো না 🥲",
  ...
  "বার বার Disturb করেছিস কোনো 😾, আমার মিলন বস এর সাথে ব্যাস্ত আসি 😋", "আমাকে না দেকে একটু পড়তে বসতেও তো পারো 🥺🥺", 
